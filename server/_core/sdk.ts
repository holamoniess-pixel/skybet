...
class OAuthService {
  constructor(private client: ReturnType<typeof axios.create>) {
    if (ENV.oAuthServerUrl) {
      console.log("[OAuth] Legacy OAuth service initialized.");
    } else {
      console.warn("[OAuth] Legacy Manus OAuth is unconfigured and will remain unavailable until Clerk migration.");
    }
  }
