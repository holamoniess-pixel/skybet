...
export function LivePage() {
  ...
  return <CustomerShell activeMobileNav="Live"><PageHeader eyebrow="Live board" title="Live SKYBET-generated matches" description="Live states and scores from the SKYBET internal market engine." /><main className="container py-5 md:py-6"><div className="mb-3 flex items-center gap-2 rounded-xl border border-[var(--sky-emerald-600)]/25 bg-[var(--sky-emerald-600)]/10 px-3 py-2 text-sm font-bold text-[var(--sky-emerald-700)] dark:text-[var(--sky-emerald-500)]"><Activity className="size-4" /> {events.length} live SKYBET-generated events</div><EventRows events={events} /></main></CustomerShell>;
}
...
export function GamesPage() {
  return <CustomerShell activeMobileNav="Sports"><PageHeader eyebrow="Games hub" title="SKYBET match engine" description="View SKYBET football pairings, upcoming/live states, forecasts, scores, and market odds." /><main className="container py-5 md:py-6"><GamesFeedPreview heading="Scores and fixtures" /><Card className="mt-3 border-[var(--sky-blue-100)] bg-[var(--sky-navy-950)] text-white dark:border-white/10"><CardContent className="flex items-center gap-3 p-3"><Gamepad2 className="size-5 text-[var(--sky-blue-300)]" /><div><p className="text-sm font-extrabold">Market information</p><p className="mt-1 text-xs leading-5 text-slate-300">Pairings, dates, scores, forecasts, and market odds are managed by SKYBET’s market engine.</p></div></CardContent></Card></main></CustomerShell>;
}
