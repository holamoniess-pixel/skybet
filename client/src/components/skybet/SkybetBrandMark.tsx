  ...
  return (
    <div className="flex items-center gap-2.5" aria-label="SKYBET">
      <span className="grid size-10 place-items-center overflow-hidden rounded-[15px] bg-[var(--sky-blue-700)] shadow-[0_8px_18px_rgba(10,63,158,0.2)] sm:size-11">
        {logoAvailable ? <img src="/manus-storage/skybet-brand-crest_119a73d2.png" alt="" className="size-full object-cover" onError={() => setLogoAvailable(false)} /> : <span className="text-sm font-black tracking-[-0.08em] text-white">SB</span>}
      </span>
