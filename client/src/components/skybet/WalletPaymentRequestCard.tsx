...
export function WalletPaymentRequestCard() {
  ...
  return (
    <div className="mt-5 space-y-5">
      ...
      <div className="flex items-start gap-2 rounded-xl bg-[var(--sky-emerald-600)]/10 p-3 text-xs leading-5 text-[var(--sky-emerald-700)] dark:text-[var(--sky-emerald-500)]"><ShieldCheck className="mt-0.5 size-4 shrink-0" />A request is not payment confirmation. Customer balances remain unchanged in this review workflow.</div>
