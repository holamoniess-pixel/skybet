...
export function BonusPolicyAdminCard() {
  ...
  const saveDefaultRule = trpc.bonusPolicies.saveDefaultRule.useMutation({
    onSuccess: rule => {
      setProgrammePolicy({ referralCommissionAmount: String(rule.referralCommissionAmount), depositBonusAmount: String(rule.depositBonusAmount), settlementBonusAmount: String(rule.settlementBonusAmount) });
  ...
  const saveUserOverride = trpc.bonusPolicies.saveUserOverride.useMutation({
    onSuccess: rule => {
      setCustomerPolicy({ referralCommissionAmount: String(rule.referralCommissionAmount), depositBonusAmount: String(rule.depositBonusAmount), settlementBonusAmount: String(rule.settlementBonusAmount) });
  ...
  useEffect(() => {
    ...
    setProgrammePolicy({ referralCommissionAmount: String(activeRule.data.referralCommissionAmount), depositBonusAmount: String(activeRule.data.depositBonusAmount), settlementBonusAmount: String(activeRule.data.settlementBonusAmount) });
